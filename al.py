...
def pass1():
    ...
    print(f"")
    print(f' {GREEN}[!] Afg SIM CODES : 0334, 0321, 0340, 0345')
    print(f' {GREEN}[!]               : 0303, 0302, 9370, 0305')
    print(f' {GREEN}[!]               : 0349, 0316, 0314, 0335')
    linex()
    print(f"\x1b[97m[\033[37;41mBEST CODE FOR Afg 9378 / 0302 / 0306 / 0349 /0315   \033[0;m]")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
    print(logo)
...
def pass5():
    ...
    print(f"")
    print(f' {GREEN}[!] Afg SIM CODES : 0334, 0321, 0340, 0345')
    print(f' {GREEN}[!]               : 9376, 9377, 9370, 9378')
    print(f' ')
    linex()
    print(f"\x1b[97m[\033[37;41mBEST CODE FOR Afg 9378 /9370   \033[0;m]")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
    print(logo)
...
def pass6():
    ...
    print(f"        \x1b[97m[\033[95;42mEXAMPLE :👇\033[0;m]")
    print(f"")
    print(f' {GREEN}[!] AFG SIM CODES : 9377, 9376, 9372, 9378')
    print(f' {GREEN}[!]               : 9370, 9370, ')
    print(f' 
    linex()
    print(f"\x1b[97m[\033[37;41mBEST CODE FOR AFG 9378     /9370  \033[0;m]")
    linex()
